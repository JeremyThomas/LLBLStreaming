...
namespace AW.Dal.HelperClasses
{
	...
	internal class ModelInfoProviderCore : ModelInfoProviderBase
	{
		...
		{
			this.InitClass();
			InitAwbuildVersionEntityInfo();
			InitDatabaseLogEntityInfo();
			InitErrorLogEntityInfo();
			InitDepartmentEntityInfo();
			InitEmployeeEntityInfo();
			InitEmployeeAddressEntityInfo();
			InitEmployeeDepartmentHistoryEntityInfo();
			InitEmployeePayHistoryEntityInfo();
			InitJobCandidateEntityInfo();
			InitShiftEntityInfo();
			InitAddressEntityInfo();
			InitAddressTypeEntityInfo();
			InitContactEntityInfo();
			InitContactTypeEntityInfo();
			InitCountryRegionEntityInfo();
			InitStateProvinceEntityInfo();
			InitBillOfMaterialEntityInfo();
			InitCultureEntityInfo();
			InitDocumentEntityInfo();
			InitIllustrationEntityInfo();
			InitLocationEntityInfo();
			InitProductEntityInfo();
			InitProductCategoryEntityInfo();
			InitProductCostHistoryEntityInfo();
			InitProductDescriptionEntityInfo();
			InitProductDocumentEntityInfo();
			InitProductInventoryEntityInfo();
			InitProductListPriceHistoryEntityInfo();
			InitProductModelEntityInfo();
			InitProductModelIllustrationEntityInfo();
			InitProductModelProductDescriptionCultureEntityInfo();
			InitProductPhotoEntityInfo();
			InitProductProductPhotoEntityInfo();
			InitProductReviewEntityInfo();
			InitProductSubcategoryEntityInfo();
			InitPurchaseOrderHistoryEntityInfo();
			InitSalesOrderHistoryEntityInfo();
			InitScrapReasonEntityInfo();
			InitTransactionHistoryEntityInfo();
			InitTransactionHistoryArchiveEntityInfo();
			InitUnitMeasureEntityInfo();
			InitWorkOrderEntityInfo();
			InitWorkOrderHistoryEntityInfo();
			InitWorkOrderRoutingEntityInfo();
			InitProductVendorEntityInfo();
			InitPurchaseOrderDetailEntityInfo();
			InitPurchaseOrderHeaderEntityInfo();
			InitShipMethodEntityInfo();
			InitVendorEntityInfo();
			InitVendorAddressEntityInfo();
			InitVendorContactEntityInfo();
			InitContactCreditCardEntityInfo();
			InitCountryRegionCurrencyEntityInfo();
			InitCreditCardEntityInfo();
			InitCurrencyEntityInfo();
			InitCurrencyRateEntityInfo();
			InitCustomerEntityInfo();
			InitCustomerAddressEntityInfo();
			InitCustomerViewRelatedEntityInfo();
			InitIndividualEntityInfo();
			InitSalesOrderDetailEntityInfo();
			InitSalesOrderHeaderEntityInfo();
			InitSalesOrderHeaderSalesReasonEntityInfo();
			InitSalesPersonEntityInfo();
			InitSalesPersonQuotaHistoryEntityInfo();
			InitSalesReasonEntityInfo();
			InitSalesTaxRateEntityInfo();
			InitSalesTerritoryEntityInfo();
			InitSalesTerritoryHistoryEntityInfo();
			InitShoppingCartItemEntityInfo();
			InitSpecialOfferEntityInfo();
			InitSpecialOfferProductEntityInfo();
			InitStoreEntityInfo();
			InitStoreContactEntityInfo();
			InitCustomerViewTypedViewInfo();
			InitCustomerViewLinqTypedViewInfo();
			InitCustomerViewQuerySpecTypedViewInfo();
			this.BuildInternalStructures();
		}

		/// <summary>Inits AwbuildVersionEntity's info objects</summary>
		private void InitAwbuildVersionEntityInfo()
		{
		...
		/// <summary>Inits DatabaseLogEntity's info objects</summary>
		private void InitDatabaseLogEntityInfo()
		{
		...
		/// <summary>Inits ErrorLogEntity's info objects</summary>
		private void InitErrorLogEntityInfo()
		{
		...
		{
			this.AddEntityInfo("EmployeeEntity", string.Empty, new EmployeeRelations(), new EmployeeEntityFactory(), 0);			
		...
		/// <summary>Inits EmployeeAddressEntity's info objects</summary>
		private void InitEmployeeAddressEntityInfo()
		{
		...
		/// <summary>Inits EmployeeDepartmentHistoryEntity's info objects</summary>
		private void InitEmployeeDepartmentHistoryEntityInfo()
		{
		...
		/// <summary>Inits EmployeePayHistoryEntity's info objects</summary>
		private void InitEmployeePayHistoryEntityInfo()
		{
		...
		/// <summary>Inits JobCandidateEntity's info objects</summary>
		private void InitJobCandidateEntityInfo()
		{
		...
		/// <summary>Inits ShiftEntity's info objects</summary>
		private void InitShiftEntityInfo()
		{
		...
		/// <summary>Inits AddressTypeEntity's info objects</summary>
		private void InitAddressTypeEntityInfo()
		{
		...
		/// <summary>Inits ContactEntity's info objects</summary>
		private void InitContactEntityInfo()
		{
		...
		/// <summary>Inits ContactTypeEntity's info objects</summary>
		private void InitContactTypeEntityInfo()
		{
		...
		/// <summary>Inits CountryRegionEntity's info objects</summary>
		private void InitCountryRegionEntityInfo()
		{
		...
		/// <summary>Inits StateProvinceEntity's info objects</summary>
		private void InitStateProvinceEntityInfo()
		{
		...
		/// <summary>Inits BillOfMaterialEntity's info objects</summary>
		private void InitBillOfMaterialEntityInfo()
		{
		...
		/// <summary>Inits CultureEntity's info objects</summary>
		private void InitCultureEntityInfo()
		{
		...
		/// <summary>Inits IllustrationEntity's info objects</summary>
		private void InitIllustrationEntityInfo()
		{
		...
		/// <summary>Inits ProductCategoryEntity's info objects</summary>
		private void InitProductCategoryEntityInfo()
		{
		...
		/// <summary>Inits ProductCostHistoryEntity's info objects</summary>
		private void InitProductCostHistoryEntityInfo()
		{
		...
		/// <summary>Inits ProductDescriptionEntity's info objects</summary>
		private void InitProductDescriptionEntityInfo()
		{
		...
		/// <summary>Inits ProductDocumentEntity's info objects</summary>
		private void InitProductDocumentEntityInfo()
		{
		...
		/// <summary>Inits ProductInventoryEntity's info objects</summary>
		private void InitProductInventoryEntityInfo()
		{
		...
		/// <summary>Inits ProductListPriceHistoryEntity's info objects</summary>
		private void InitProductListPriceHistoryEntityInfo()
		{
		...
		/// <summary>Inits ProductModelEntity's info objects</summary>
		private void InitProductModelEntityInfo()
		{
		...
		/// <summary>Inits ProductModelIllustrationEntity's info objects</summary>
		private void InitProductModelIllustrationEntityInfo()
		{
		...
		/// <summary>Inits ProductModelProductDescriptionCultureEntity's info objects</summary>
		private void InitProductModelProductDescriptionCultureEntityInfo()
		{
		...
		/// <summary>Inits ProductPhotoEntity's info objects</summary>
		private void InitProductPhotoEntityInfo()
		{
		...
		/// <summary>Inits ProductProductPhotoEntity's info objects</summary>
		private void InitProductProductPhotoEntityInfo()
		{
		...
		/// <summary>Inits ProductSubcategoryEntity's info objects</summary>
		private void InitProductSubcategoryEntityInfo()
		{
		...
		/// <summary>Inits PurchaseOrderHistoryEntity's info objects</summary>
		private void InitPurchaseOrderHistoryEntityInfo()
		{
		...
		/// <summary>Inits SalesOrderHistoryEntity's info objects</summary>
		private void InitSalesOrderHistoryEntityInfo()
		{
		...
		/// <summary>Inits ScrapReasonEntity's info objects</summary>
		private void InitScrapReasonEntityInfo()
		{
		...
		/// <summary>Inits TransactionHistoryEntity's info objects</summary>
		private void InitTransactionHistoryEntityInfo()
		{
		...
		/// <summary>Inits TransactionHistoryArchiveEntity's info objects</summary>
		private void InitTransactionHistoryArchiveEntityInfo()
		{
		...
		/// <summary>Inits UnitMeasureEntity's info objects</summary>
		private void InitUnitMeasureEntityInfo()
		{
		...
		/// <summary>Inits WorkOrderEntity's info objects</summary>
		private void InitWorkOrderEntityInfo()
		{
		...
		/// <summary>Inits WorkOrderHistoryEntity's info objects</summary>
		private void InitWorkOrderHistoryEntityInfo()
		{
		...
		/// <summary>Inits WorkOrderRoutingEntity's info objects</summary>
		private void InitWorkOrderRoutingEntityInfo()
		{
		...
		/// <summary>Inits ProductVendorEntity's info objects</summary>
		private void InitProductVendorEntityInfo()
		{
		...
		/// <summary>Inits PurchaseOrderDetailEntity's info objects</summary>
		private void InitPurchaseOrderDetailEntityInfo()
		{
		...
		/// <summary>Inits PurchaseOrderHeaderEntity's info objects</summary>
		private void InitPurchaseOrderHeaderEntityInfo()
		{
		...
		/// <summary>Inits ShipMethodEntity's info objects</summary>
		private void InitShipMethodEntityInfo()
		{
		...
		/// <summary>Inits VendorAddressEntity's info objects</summary>
		private void InitVendorAddressEntityInfo()
		{
		...
		/// <summary>Inits VendorContactEntity's info objects</summary>
		private void InitVendorContactEntityInfo()
		{
		...
		/// <summary>Inits ContactCreditCardEntity's info objects</summary>
		private void InitContactCreditCardEntityInfo()
		{
		...
		/// <summary>Inits CountryRegionCurrencyEntity's info objects</summary>
		private void InitCountryRegionCurrencyEntityInfo()
		{
		...
		/// <summary>Inits CreditCardEntity's info objects</summary>
		private void InitCreditCardEntityInfo()
		{
		...
		/// <summary>Inits CurrencyRateEntity's info objects</summary>
		private void InitCurrencyRateEntityInfo()
		{
		...
		{
			this.AddEntityInfo("CustomerEntity", string.Empty, new CustomerRelations(), new CustomerEntityFactory(), 0);			
		...
		/// <summary>Inits CustomerAddressEntity's info objects</summary>
		private void InitCustomerAddressEntityInfo()
		{
		...
		/// <summary>Inits CustomerViewRelatedEntity's info objects</summary>
		private void InitCustomerViewRelatedEntityInfo()
		{
		...
		/// <summary>Inits IndividualEntity's info objects</summary>
		private void InitIndividualEntityInfo()
		{
			this.AddEntityInfo("IndividualEntity",  "CustomerEntity" , new IndividualRelations(), new IndividualEntityFactory(), 1);			
		...
		/// <summary>Inits SalesOrderDetailEntity's info objects</summary>
		private void InitSalesOrderDetailEntityInfo()
		{
		...
		/// <summary>Inits SalesOrderHeaderEntity's info objects</summary>
		private void InitSalesOrderHeaderEntityInfo()
		{
		...
		/// <summary>Inits SalesOrderHeaderSalesReasonEntity's info objects</summary>
		private void InitSalesOrderHeaderSalesReasonEntityInfo()
		{
		...
		/// <summary>Inits SalesPersonEntity's info objects</summary>
		private void InitSalesPersonEntityInfo()
		{
			this.AddEntityInfo("SalesPersonEntity",  "EmployeeEntity" , new SalesPersonRelations(), new SalesPersonEntityFactory(), 1);			
		...
		/// <summary>Inits SalesPersonQuotaHistoryEntity's info objects</summary>
		private void InitSalesPersonQuotaHistoryEntityInfo()
		{
		...
		/// <summary>Inits SalesReasonEntity's info objects</summary>
		private void InitSalesReasonEntityInfo()
		{
		...
		/// <summary>Inits SalesTaxRateEntity's info objects</summary>
		private void InitSalesTaxRateEntityInfo()
		{
		...
		/// <summary>Inits SalesTerritoryEntity's info objects</summary>
		private void InitSalesTerritoryEntityInfo()
		{
		...
		/// <summary>Inits SalesTerritoryHistoryEntity's info objects</summary>
		private void InitSalesTerritoryHistoryEntityInfo()
		{
		...
		/// <summary>Inits SpecialOfferEntity's info objects</summary>
		private void InitSpecialOfferEntityInfo()
		{
		...
		/// <summary>Inits SpecialOfferProductEntity's info objects</summary>
		private void InitSpecialOfferProductEntityInfo()
		{
		...
		/// <summary>Inits StoreEntity's info objects</summary>
		private void InitStoreEntityInfo()
		{
			this.AddEntityInfo("StoreEntity",  "CustomerEntity" , new StoreRelations(), new StoreEntityFactory(), 1);			
		...
		/// <summary>Inits StoreContactEntity's info objects</summary>
		private void InitStoreContactEntityInfo()
		{
		...
		/// <summary>Inits CustomerViewView's info objects</summary>
		private void InitCustomerViewTypedViewInfo()
		{
		...
		/// <summary>Inits CustomerViewLinqView's info objects</summary>
		private void InitCustomerViewLinqTypedViewInfo()
		{
		...
		/// <summary>Inits CustomerViewQuerySpecView's info objects</summary>
		private void InitCustomerViewQuerySpecTypedViewInfo()
		{
