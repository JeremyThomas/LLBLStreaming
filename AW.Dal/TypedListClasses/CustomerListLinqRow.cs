...
namespace AW.Dal.TypedListClasses
{
	...
	/// <remarks>This class is a result class for a query, which is produced with the method <see cref="AW.Dal.Linq.LinqMetaData.GetCustomerListLinqTypedList"/>.
	...
	/// </remarks>
	[Serializable]
	public partial class CustomerListLinqRow : PocoBase, AW.Dal.HelperClasses.IIndividualCustomer
	{
