...
namespace AW.Dal.TypedListClasses
{
	...
	/// <remarks>This class is a result class for a query, which is produced with the method <see cref="AW.Dal.FactoryClasses.QueryFactory.GetCustomerListQuerySpecTypedList"/>.
	...
	/// </remarks>
	[Serializable]
	public partial class CustomerListQuerySpecRow : PocoBase, AW.Dal.HelperClasses.IIndividualCustomer
	{
