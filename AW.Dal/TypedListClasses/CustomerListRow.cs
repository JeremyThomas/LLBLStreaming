...
namespace AW.Dal.TypedListClasses
{
	/// <summary>Class which represents a row in the typed list 'Sales.CustomerList'.</summary>
	/// <remarks>This class is a result class for a query, which is produced with the method <see cref="AW.Dal.Linq.LinqMetaData.GetCustomerListTypedList"/>.
	...
	/// </remarks>
	[Serializable]
	public partial class CustomerListRow 
	{
		partial void OnCreated();
		
		/// <summary>Initializes a new instance of the <see cref="CustomerListRow"/> class.</summary>
		public CustomerListRow()
		{
			OnCreated();
		}
