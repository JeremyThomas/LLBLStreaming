...
namespace AW.Dal.TypedViewClasses
{
	...
	/// <remarks>This class is a result class for a query, which is produced with the property <see cref="AW.Dal.FactoryClasses.QueryFactory.CustomerViewQuerySpec"/>. </remarks>
	[Serializable]
	public partial class CustomerViewQuerySpecRow : PocoBase, AW.Dal.HelperClasses.IIndividualCustomer
	{
