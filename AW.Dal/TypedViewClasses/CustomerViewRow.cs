...
{
	/// <summary>Class which represents a row in the typed view 'Sales.CustomerView'.</summary>
	/// <remarks>This class is a result class for a query, which is produced with the property <see cref="AW.Dal.Linq.LinqMetaData.CustomerView"/>. </remarks>
	[Serializable]
	public partial class CustomerViewRow 
	{
		partial void OnCreated();
		
		/// <summary>Initializes a new instance of the <see cref="CustomerViewRow"/> class.</summary>
		public CustomerViewRow()
		{
			OnCreated();
		}
